        ...
        @if (Auth::check())
            <div class="m-5">
                <a class="position-relative" style="text-decoration: none; color:black" href="{{ url('cart') }}"><svg
                    ...
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary">{{ app('App\Http\Controllers\CartController')->getNumberOfOrders() }}</span>
                </a>
            </div>
